...
public class DeviceTypeControllerTest {
    ...
    void testCreateSuccess() throws Exception {
        CourseTypeDTO dto = CourseTypeDTO.builder().name("device type moi").build();
        String json = new ObjectMapper().writeValueAsString(dto);
        MvcResult result = mvc.perform(post("/device-types")
                        .content(json)
    ...
    void testCreateErrorEmpty() throws Exception {
        ...
        Assertions.assertTrue(x.contains("Tên kiểu thiết bị không được bỏ trống"));
    }
    ...
    void testCreateErrorLength() throws Exception {
        CourseTypeDTO dto = CourseTypeDTO.builder().name("6te").build();
        String json = new ObjectMapper().writeValueAsString(dto);
        MvcResult result = mvc.perform(post("/device-types")
                        .content(json)
                        .contentType(MediaType.APPLICATION_JSON)
